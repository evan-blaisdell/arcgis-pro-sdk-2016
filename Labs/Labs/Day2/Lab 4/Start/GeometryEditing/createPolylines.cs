...
namespace GeometryEditingExercises
{
    /// <summary>
    ...
    internal class createPolylines : Button
    {
        protected override async void OnClick()
        {
            ...
            // TODO
            // retrieve the first point layer from the active map
        ...
        private Task<bool> constructSamplePolylines(FeatureLayer polylineLayer, FeatureLayer pointLayer)
        {
            ...
            return QueuedTask.Run(() =>
            {
                ...
                // TODO: create a ProjectionTransformation from the points to the lines for use in GeometryEngine.ProjectEx
                //  HINT: Use ProjectionTransformation.CreateFromEnvironment
