    ...
    private Task ApplySelectedSymbol()
    {
        ...
        return QueuedTask.Run(() =>
        {
            ...
            foreach (var layer in selectedLayers)
            {
                ...
                {
                    var uvr = layer.CreateRenderer(new UniqueValueRendererDefinition(new string[1] { fieldDescription.Name }, symbolReference));
